...
#define DXLCMD_MAX_NODE               _HW_DEF_DXLCMD_MAX_NODE
#define DXLCMD_MAX_NODE_BUFFER_SIZE   _HW_DEF_DXLCMD_MAX_NODE_BUFFER_SIZE
#define DXLCMD_MAX_BUFFER             _HW_DEF_DXLCMD_BUFFER_MAX
